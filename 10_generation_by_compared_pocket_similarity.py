...
##########################################################################################################################
                            ...
                            # 选取第2、4列并另存为csv文件
                            top_1000_rows.to_csv('selected_pdbfile_by_compared_pocket_similarity_refined_1000_nik.csv', index=None)
                            ...
                            fragments_df.to_csv('fragments_file_by_compared_pocket_similarity_refined_1000_nik.csv', index=None)
                            
                            # 将碎片库单独另存为csv文件
                            fragment_library = list(set(fragments_df['fragment'].tolist()))
                            fragment_library_df = pd.DataFrame(fragment_library, columns=['fragment'])
                            fragment_library_df.to_csv('fragment_library_file_by_compared_pocket_similarity_refined_1000_nik.csv', index=None)
                            ...
                            new_molecules_df.to_csv('new_molecules_file_by_compared_pocket_similarity_refined_filter_10000_nik.csv', index=None)
