...
#df = pd.read_csv("./uniprot_pdb_list_homo.csv", usecols=["accession","sequence"])
...
##########################################################################################################################
                         ...
                         #   top_1000_rows.to_csv('selected_pdbfile_by_pocket_seq_similarity_1000_nik.csv', index=None)
                            top_1000_rows.to_csv('selected_pdbfile_by_pocket_seq_similarity_1000.csv', index=None)
                            ...
                            fragments_df.to_csv('fragments_file_by_pocket_seq_similarity.csv', index=None)
                          ...
                          #  fragment_library_df.to_csv('fragment_library_file_by_pocket_seq_similarity_nik.csv', index=None)
                            fragment_library_df.to_csv('fragment_library_file_by_pocket_seq_similarity.csv', index=None)
